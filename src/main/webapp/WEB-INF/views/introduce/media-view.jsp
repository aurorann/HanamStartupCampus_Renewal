        ...
        <div class="inner">
            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                            ...
                            <tr>
                                <td>
                                    <div class="board-title">
                                    	<span class="white-label">소개 / 동영상</span>
                    ...
                    <button type="button" class="search-btn mg-top-30" onclick="location.href='<c:url value="/introduce/media/list" />'" style="margin-right: 10px;">목록</button>
                    <sec:authorize ifAnyGranted="ROLE_ADMIN">
						<button type="button" class="search-btn mg-top-30" onclick="location.href='<c:url value="/admin/introduce/media/edit/form/" />${SEQ_ID}';" style="margin-right: 10px;">수정</button>
			...
			function deleteNoticePost(seqId) {
				if(confirm("해당 게시물을 삭제하시겠습니까?")) {
					$.ajax({
						type : 'POST',
						cache: false,
						url : '<c:url value="/admin/introduce/media/post/remove" />/' + seqId,
						headers : {
						...
						success : function(result) {
							if(result.count > 0) {
								...
								location.href = '<c:url value="/introduce/media/list" />';	
							} else {
