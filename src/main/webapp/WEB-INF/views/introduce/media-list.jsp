            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                	...
                	<div class="col-lg-12" style="margin:0; padding:0;">
                        <h3 class="m-title"><img src="<c:url value='/resources/img/sub-title.png' />" alt="제목 아이콘">&nbsp;&nbsp;하남스타트업캠퍼스 소개 영상</h3>
                    </div>
                    ...
                    <div class="sm-main-box pink-bar flex-end">
                        ...
                        <div>
                        	<form id="searchForm" action="<c:url value='/introduce/media/list' />" method="get" onsubmit="return searchNoticeList(this)">								
				...
				success : function(res) {
					...
					commonPost.every(function(el) {
						...
						var commonHTML = '<li class="hongbo-item">' +
	                            '<a href="<c:url value='/introduce/media/view' />/' + el.seqId + '" class="hongbo-img">' +
	                                '<div class="ent-logo">' +
	                            ...
	                            '</a>' +
	                            '<div class="caption">' + 
	                                '<a href="<c:url value='/introduce/media/view' />/' + el.seqId + '">' +
