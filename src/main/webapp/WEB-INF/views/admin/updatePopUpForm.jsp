					...
					<div class="col-lg-4">
						...
						<div class="card1">
							...
							<div class="card-body1">
									...
									<input class="form-control mb-4" data-valid="title" type="text" id="title" name="title" required="required" style="width:63%; max-width:180px;" value="${dto.title}"> 
									
									<label for="link">팝업 링크</label>
									<input type="text" name="link" id="link" class="form-control mb-4" style="width:63%; max-width:180px;" value="${dto.link}">
									
									<label for="contents_width" style="display: block;">팝업 크기</label>
									<input type="number" name="contentsWidth" id="contents_width" min="100" class="form-control mb-4" max="1920" style="display: inline-block;" value="${dto.contentsWidth}" required="" placeholder="너비">
									<input type="number" name="contentsHeight" id="contents_height" min="100" class="form-control mb-4" max="1080" style="display: inline-block;" value="${dto.contentsHeight}" required="" placeholder="높이">
									<input type="button" class="btn btn-primary" id="resize" value="적용">
									
									<label for="display_position_x" style="display: block;">팝업 위치</label>
									<input type="number" name="displayPositionX" id="display_position_x" min="0" max="1920" class="form-control mb-4" value="${dto.displayPositionX}" style="display: inline-block;" required="" placeholder="X좌표">
									<input type="number" name="displayPositionY" id="display_position_y" min="0" max="1080" class="form-control mb-4" value="${dto.displayPositionY}" style="display: inline-block;" required="" placeholder="Y좌표">
	
									<label for="display_date" style="display: block;">표출 기한</label>
									<input type="text" name="displayDate" id="display_date" class="form-control mb-4" readonly="readonly" reuired="required" value="${dto.displayDate}"  style="cursor: pointer; background-color: white;width:63%; max-width:180px;">
