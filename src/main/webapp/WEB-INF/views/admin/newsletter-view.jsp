    ...
    <div class="sub_container in_1400">
		...
		<main>
            ...
            <div class="container_txt">
                <div class="board_label board_label_gongo"data-post-element="level">뉴스레터</div>
            ...
            <div class="page_btn_wrap">
            	<div class="back_btn">
            		<a href="<c:url value="/admin/newsletter/list" />">목록</a>
            	</div>
            	
            	<sec:authorize ifAnyGranted="ROLE_ADMIN">
	            	<div class="function_btns">
						<a href="<c:url value="/admin/newsletter/edit/form/" />${SEQ_ID}" class="modify_btn">수정</a>
