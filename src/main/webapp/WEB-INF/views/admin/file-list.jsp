			...
			<!-- # include: title-box end -->
				...
				<div class="container_wrap">
	                ...
	                <table class="board_wrap">
	                    ...
	                    <tbody class="board_body file-list">
	                    	<!-- 
	                        <tr>
...
<%-- 					<button type="submit" class="" onclick="location.href='<c:url value="/admin/partner/file/write/form" />';" style="margin-top: 20px;">글쓰기</button> --%>
					
                    <div class="pagination_wrap">
					</div>
	                <a href='<c:url value="/admin/partner/file/write/form" />' class="write_btn">글쓰기</a>
		...
		function getPostList(curPage) {
			$.ajax({
				...
				success : function(res) {
					...
					commonPost.every(function(el) {
						var titleString = (el.title.length > 28) ?
								...
								var commonHTML = '<tr>'
									...
									+ '<td class="board_title">'
									+ '<a href="<c:url value='/admin/partner/file/view' />/' + el.seqId + '">' + titleString + '</a>'
									+ '</td>'
					...
					$("tbody.board_body.file-list").html(commonArr.join(""));
