...
<body class="animsition restyle-index">
			...
			<!-- # include: title-box end -->
                    ...
                    <!-- 
						<div class="btn-group btn-group-justified" role="group" aria-label="Justified button group"  style="padding-bottom: 20px;">
					      ...
					      <a href="javascript:void(0);" class="btn btn-default you-are-here" role="button">사업공고 글쓰기</a>
		                ...
		                <div class="board_write_wrap">
		                    <div class="board_write_title">
		                        <div class="labelWrap">
		                            <input type="radio" id="Ggongo" name="notice_level" value="101" name="announcement_level" checked="checked">
		                            <label for="Ggongo" class="board_label board_label_Ggongo">주요공고</label>
		                            <input type="radio" id="gongo" name="notice_level" value="102" name="announcement_level">
                                        ...
                                        <div class="board-title">
                                            <div class="bd-example">
												<div class="form-check form-check-inline">
												  <input class="form-check-input" type="radio" name="announcement_level" id="announcementLevel100" value="100" checked="checked">
												  <label class="pink-label" for="announcementLevel0">주요공지</label>
												</div>
												<div class="form-check form-check-inline">
												  <input class="form-check-input" type="radio" name="announcement_level" id="announcementLevel101" value="101">
												  <label class="yellow-label" for="announcementLevel1">주요공고</label>
												</div>
												<div class="form-check form-check-inline">
												  <input class="form-check-input" type="radio" name="announcement_level" id="announcementLevel102" value="102">
												  <label class="white-label" for="announcementLevel2">공지</label>
												</div>
												<div class="form-check form-check-inline">
												  <input class="form-check-input" type="radio" name="announcement_level" id="announcementLevel103" value="103">
												  <label class="white-label" for="announcementLevel3">공고</label>
												</div>
											</div>
	...
	<script >
		...
		function writeNewPost() {
			...
			var announcementLevel = document.querySelector('[name="announcement_level"]:checked').value;
			...
			if(title.trim() === '' || title.length > 50) {
				...
				return false;
			} else if(typeof announcementLevel === "undefined" ||announcementLevel === '') {
				alert('게시글 타입을 정해주세요.');
				return false;
