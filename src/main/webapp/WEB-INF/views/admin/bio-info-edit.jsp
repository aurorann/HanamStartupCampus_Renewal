            ...
            <div class="right-contents col-lg-9">
                    ...
                    <div class="col-lg-12 r-contents">
                    	...
                    	<div class="col-lg-12" style="margin:0; padding:0;">
	                        <h3 class="m-title"><img src="<c:url value='/resources/img/sub-title.png' />">&nbsp;&nbsp;바이오 소식 수정</h3>
	                    </div>
	                            	...
	                            	<tr>
									    <td>
									    	<div class="gallery-represent-wrapper">
									    		<img id="representImageExample" src="<c:url value='/upload/gallery-represent/bio-info' />/${REPRESENT_IMAGE}" onerror="this.src=\'<c:url value='/resources/img/default.png' />\'" src="<c:url value='/resources/img/default.png' />" />
									    	</div>
									    </td>
									</tr>
	                                <tr>
						      ...
						      <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group" style="
								...
								">
								      ...
								      <div class="btn-group" role="group" style="margin-top: 10px">
								      	<button type="button" class="btn btn-default" onclick="location.href='<c:url value='/gallery/bio-info/view' />/${SEQ_ID}';">돌아가기</button>
								      </div>
	...
	<script >
		$(function() {	// DOM init
			...
			CKEDITOR.replace('post_editor', {
				height: 450,
				filebrowserUploadUrl: '<c:url value="/admin/bio-info/upload/image" />',
		...
		function editPost() {
			...
			if(confirm('게시글을 수정하시겠습니까?')) {
				$.ajax({
					cache : false,
					type : 'POST',
					url : '<c:url value="/admin/gallery/bio-info/post/edit" />/${SEQ_ID}',
					headers : {
						'${_csrf.headerName}' : '${_csrf.token}'
					},
					processData : false,
					...
					success : function(result) {
						if(result.count > 0) {
							...
							location.href = '<c:url value="/gallery/bio-info/view" />/${SEQ_ID}';	
						} else {
