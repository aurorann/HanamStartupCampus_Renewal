	...
	<script>
		...
		function getPostList(curPage) {
			$.ajax({
				type : 'GET',
				cache: false,
				url : '<c:url value="/admin/partner/news/post/list" />',
				data: {
				...
				success : function(res) {
					...
					commonPost.every(function(el) {
						...
						var commonHTML = '<li class="hongbo-item">' + // style="height: 360px;"
                           '<a href="<c:url value='/admin/partner/news/view' />/' + el.seqId + '" class="hongbo-img">' +
                               '<div class="ent-logo">' +
                           ...
                           '</a>' +
                           '<div class="caption">' + 
                               '<a href="<c:url value='/admin/partner/news/view' />/' + el.seqId + '">' +
