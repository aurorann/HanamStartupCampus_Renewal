            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                    ...
                    <div class="sm-main-box pink-bar flex-end">
                        ...
                        <div>
                        	<form id="searchForm" action="<c:url value='/gallery/promotion/list' />" method="get" action="#" onsubmit="return searchNoticeList(this)">								
	...
	<script>
		...
		function getPostList(curPage) {
			$.ajax({
				type : 'GET',
				cache: false,
				url : '<c:url value="/gallery/promotion/post/list" />',
				data: {
				...
				success : function(res) {
					...
					commonPost.every(function(el) {
						...
						var commonHTML = '<li class="bodo-item">' +
                                '<a href="<c:url value='/gallery/promotion/view' />/' + el.seqId + '" class="bodo-img">' +
                                    '<div class="ent-logo">' +
                                        '<div class="ent-logo-detail">' +
                                            '<img src="<c:url value='/upload/gallery-represent/promotion' />/' + el.representImage + '" onerror="this.src=\'<c:url value='/resources/img/default.png' />\'">' +
                                        '</div>' +
                                    '</div>' +
                                '</a>' +
                                '<div class="caption"> ' +
                                    '<a href="<c:url value='/gallery/promotion/view' />/' + el.seqId + '">' +
