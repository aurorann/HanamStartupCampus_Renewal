        ...
        <div class="inner">
            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                    ...
                    <button type="button" class="search-btn mg-top-30" onclick="location.href='<c:url value="/gallery/promotion/list" />'" style="margin-right: 10px;">목록</button>
                    <sec:authorize ifAnyGranted="ROLE_ADMIN">
						<button type="button" class="search-btn mg-top-30" onclick="location.href='<c:url value="/admin/gallery/promotion/edit/form/" />${SEQ_ID}';" style="margin-right: 10px;">수정</button>
			...
			function deleteNoticePost(seqId) {
				if(confirm("해당 게시물을 삭제하시겠습니까?")) {
					$.ajax({
						type : 'POST',
						cache: false,
						url : '<c:url value="/admin/gallery/promotion/post/remove" />/' + seqId,
						headers : {
