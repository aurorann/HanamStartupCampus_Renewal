        ...
        <div class="inner">
            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                            ...
                            <tr>
                                <td>
                                    <div class="board-title">
                                    	<span class="white-label">바이오 소식</span>
                        	...
                        	<tr>
							    <td>
							    	<div class="gallery-represent-wrapper">
							    		<img id="representImageExample"  onerror="this.src='<c:url value='/resources/img/default.png' />'" src="<c:url value='/upload/gallery-represent/bio-info' />/${REPRESENT_IMAGE}" />
							    	</div>
							    </td>
							</tr>
                            <tr>
								...
								<c:forEach items="${fileNames}" varStatus="status">
									<tr>
										<td>
											...
											<small id="attach" data-post-element="file" onclick="document.getElementById('attachForm${status.index}').submit();">${fileNames[status.index]}</small>
                    ...
                    <button type="button" class="search-btn mg-top-30" onclick="location.href='<c:url value="/gallery/bio-info/list" />'" style="margin-right: 10px;">목록</button>
                    <sec:authorize ifAnyGranted="ROLE_ADMIN">
						<button type="button" class="search-btn mg-top-30" onclick="location.href='<c:url value="/admin/gallery/bio-info/edit/form/" />${SEQ_ID}';" style="margin-right: 10px;">수정</button>
			...
			function deleteNoticePost(seqId) {
				if(confirm("해당 게시물을 삭제하시겠습니까?")) {
					$.ajax({
						type : 'POST',
						cache: false,
						url : '<c:url value="/admin/gallery/bio-info/post/remove" />/' + seqId,
						headers : {
						...
						success : function(result) {
							if(result.count > 0) {
								...
								location.href = '<c:url value="/gallery/bio-info/list" />';	
							} else {
