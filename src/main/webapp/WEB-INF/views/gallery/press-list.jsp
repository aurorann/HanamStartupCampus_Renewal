            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                    ...
                    <div class="sm-main-box pink-bar flex-end">
                        ...
                        <div>
                        	<form id="searchForm" action="<c:url value='/gallery/press/list' />" method="get" action="#" onsubmit="return searchNoticeList(this)">								
				...
				success : function(res) {
					...
					commonPost.every(function(el) {
						...
						var commonHTML = '<li class="bodo-item">' +
                                '<a href="<c:url value='/gallery/press/view' />/' + el.seqId + '" class="bodo-img">' +
                                    '<div class="ent-logo">' +
                                        '<div class="ent-logo-detail">' +
                                ...
                                '</a>' +
                                '<div class="caption"> ' +
                                    '<a href="<c:url value='/gallery/press/view' />/' + el.seqId + '">' +
