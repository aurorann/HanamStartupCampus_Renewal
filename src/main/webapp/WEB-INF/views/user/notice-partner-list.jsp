            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="container_wrap">
	                ...
	                <div class="search_wrap">
	                    ...
	                    <form class="search_form" id="searchForm" action="<c:url value='/user/partner/notice/list' />" method="get" action="#" onsubmit="return searchNoticeList(this)">
	                ...
	                <table class="board_wrap">
	                    <thead class="board_hd">
	                        <tr>
	                            ...
	                            <th class="board_view" style="width:62%">제목</th>
	                            <th class="board_start" style="width:10%">작성자</th>
	                            <th class="board_end" style="width:10%">게시일</th>
	                            <th class="board_end" style="width:10%">조회수</th>
	                        </tr>
	                    </thead>
	
	                    <tbody class="board_body common-notice">
	                    	<!-- 
	                        <tr>
					...
					<!-- <button type="submit" class="search-btn" onclick="location.href='<c:url value="/user/partner/notice/write/form" />';" style="margin-top: 20px;">글쓰기</button> -->
	...
	<script>
		...
		function getPostList(curPage) {
			$.ajax({
				type : 'GET',
				cache: false,
				url : '<c:url value="/user/partner/notice/post/list" />',
				data: {
				...
				success : function(res) {
					...
					commonPost.every(function(el) {
						...
						var commonHTML = '<tr>'
							...
							+ '<td class="board_title">'
							+ '<a href="<c:url value='/user/partner/notice/view' />/' + el.seqId + '">' + titleString + '</a>'
							+ '</td>'
					...
					$("tbody.board_body.common-notice").html(commonArr.join(""));
