            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                    ...
                    <div class="sm-main-box pink-bar flex-end">
                        ...
                        <div>
                        	<form id="searchForm" action="<c:url value='/user/partner/notice/list' />" method="get" action="#" onsubmit="return searchNoticeList(this)">								
	...
	<script>
		...
		function getPostList(curPage) {
			$.ajax({
				type : 'GET',
				cache: false,
				url : '<c:url value="/partner/notice/post/list" />',
				data: {
					...
					commonPost.every(function(el) {
						...
						var commonHTML = '<li class="board-item">' +
		                    '<strong class="item-nmb">' + el.seqId + '</strong>' +
	                            ...
	                            '<span><a href="<c:url value='/user/partner/notice/view' />/' + el.seqId + '">' + titleString + '</a></span>' +
	                            '</div>' +
	                            '<div class="item-info">' +
