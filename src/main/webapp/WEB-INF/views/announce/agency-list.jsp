            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                    ...
                    <div class="sm-main-box pink-bar flex-end">
                        ...
                        <div>
                        	<form id="searchForm" action="<c:url value='/announce/agency/list' />" method="get" action="javascript:void(0);" onsubmit="return searchNoticeList(this)">								
			...
			$.ajax({
				...
				success : function(res) {
					...
					commonPost.every(function(el) {
						...
						var agencyNameString = (el.agencyName.length > 9) ?
								el.agencyName.slice(0, 9) + "..."
								: el.agencyName;
						
						var commonHTML = '<li class="board-item">' +
		                    '<strong class="item-nmb">' + el.seqId + '</strong>' +
		                    '<div class="item-label faq-label">' +
		                    '<span class="white-label">' + agencyNameString + '</span>' +
		                	'</div>' +
	                            '<div class="item-title">' +
	                            '<span><a href="<c:url value='/announce/agency/view' />/' + el.seqId + '">' + titleString + '</a></span>' +
	                            '</div>' +
	                            '<div class="item-info">' +
