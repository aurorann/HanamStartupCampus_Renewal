		...
		<main>
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                            ...
                            <tr>
                                <td>
                                    <div class="board-title">
                                        <span data-post-element="level" class="white-label">자주 묻는 질문</span>
                    ...
                    <button type="button" class="search-btn mg-top-30" onclick="location.href='<c:url value="/announce/faq/list" />'" style="margin-right: 10px;">목록</button>
			...
			function deleteNoticePost(seqId) {
				if(confirm("해당 게시물을 삭제하시겠습니까?")) {
					$.ajax({
						type : 'POST',
						cache: false,
						url : '<c:url value="/admin/announce/faq/post/remove" />/' + seqId,
						headers : {
						...
						success : function(result) {
							if(result.count > 0) {
								...
								location.href = '<c:url value="/announce/faq/list" />';	
							} else {
