    ...
    <div class="sub_container in_1400">
		...
		<main>
            ...
            <div class="container_txt">
                ...
                <ul>
                    <li>등록일<span data-post-element="contractStartAt">${CONTRACT_START_AT}</span></li>
                    <li>마감일<span data-post-element="contractEndAt" >${CONTRACT_END_AT}</span></li>
            ...
            <div class="page_btn_wrap">
            	<div class="back_btn">
            		<a href="<c:url value="/announce/announcement/list" />">목록</a>
            	</div>
            	<sec:authorize ifAnyGranted="ROLE_ADMIN">
	            	<div class="function_btns">
						<a href="<c:url value="/admin/announce/announcement/edit/form/" />${SEQ_ID}" class="modify_btn">수정</a>
			...
			function deleteNoticePost(seqId) {
				if(confirm("해당 게시물을 삭제하시겠습니까?")) {
					$.ajax({
						type : 'POST',
						cache: false,
						url : '<c:url value="/admin/announce/announcement/post/remove" />/' + seqId,
						headers : {
