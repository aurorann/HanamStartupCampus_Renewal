            ...
            <div class="right-contents col-lg-9">
                ...
                <div class="col-lg-12 r-contents">
                    <div class="col-lg-5 mg-top-30">
                        <img src="<c:url value='/resources/img/room/room_all.png' />">
                    </div>

                    <div class="col-lg-7 mg-top-30">
                        <h3 class="b-title">입주기업을 위한 회의 장소 대관</h3>
                        <p class="b-text">하남 스타트업 캠퍼스 입주 기업을 위한 회의 장소 대관 서비스를 제공합니다.
                            신청하실 회의실과 시간을 선택해 장소를 대관하실 수 있습니다.
                            예약 현황을 확인해 보세요.</p>
                    ...
                    <div class="col-lg-12" style="margin:0; padding:0;">
                        ...
                        <div class="col-lg-4 vartical-box pink-bar mg-top-60">
                            ...
                            <ul>
                                <li>가로(m) x 세로(m)<span>4.500 x 3.500</span></li>
                                <li>면적(m²)<span>15,750</span></li>
