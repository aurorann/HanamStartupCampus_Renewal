    ...
    function html5Upload() {	
    	...
    	sUploadURL= sessionStorage.getItem("contextpath")+'/common/multiplePhotoUpload.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			sUrl  : sessionStorage.getItem("contextpath")+'/common/photoUpload.do', //변경 URL입니다.
			sCallback : '/resources/se2/upload/photo_uploader/callback.html', //업로드 이후에 iframe이 redirect될 콜백페이지의 주소
